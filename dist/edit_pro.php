          ...
          <form action="" method="POST" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="mb-3 form-check">
                <input type="radio" class="form-check-input" id="in_stock" name="pro_status" value="<?php echo $row['pro_status']; ?>" checked>
                <label class="form-check-label" for="in_stock">In stock</label>
              </div>
              <div class="mb-3 form-check">
                <input type="radio" class="form-check-input" id="not_in_stock" name="pro_status" value="<?php echo $row['pro_status']; ?>">
              ...
              <div class="mb-3">
                ...
                <img src="assets/pro_img/<?php echo htmlspecialchars($row['image']); ?>" width="250px" height="250px" alt="รูปภาพเดิม" class="mb-3" />
              </div>
              <div class="mb-3">
